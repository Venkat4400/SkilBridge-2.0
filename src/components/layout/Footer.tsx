        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/opportunities" className="hover:text-secondary transition-colors">
                  Post Opportunities
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to="https://www.linkedin.com/in/venkat2026/" className="hover:text-primary transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="https://github.com/Venkat4400" className="hover:text-primary transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
